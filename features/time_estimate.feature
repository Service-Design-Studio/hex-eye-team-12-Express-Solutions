...
Scenario: Customer checks the non-migratable service
    ...
    When I click on the "Category" of "ATM/Debit Card"
    And I click on the "service" of "Update Debit Card"
...
Scenario: Customer chooses another branch
    ...
    When I click on the "Category" of "ATM/Debit Card"
    And I click on the "service" of "Update Debit Card"
    Then I should see the branch time estimate with "16 min"
    When I select the branch of "Bukit Batok Central Branch" in the dropdown
    Then I should see the branch time estimate with "12 min"
    And I should not see the branch time estimate with "16 min"
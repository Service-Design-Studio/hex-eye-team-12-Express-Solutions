...
Scenario: Customer using Web, at MBFC Branch, clicks on Update Phone
    ...
    And I click on the "category" of "Personal Info Update"
    ...
    And I should see a QR with "sms:+6595559001?&body=Q Update Phone"
...
Scenario: Customer using Android, at Bedok Central Branch, clicks on Update Particulars
    ...
    And I should see a QR with "sms:+6595559002?&body=Q Update Particulars"
...
Scenario: Customer using iPhone, at Tiong Bahru Branch, clicks on Cash Deposit
    ...
    And I click on the "category" of "ATM/Debit Card"
    ...
    And I should see a QR with "sms:/+6595559025/&body=Q ATM Card Replacement"
...
And I should see the headers "Update Particulars, Do it digitally, Do it at a branch"

@javascript
Scenario: Customer selects wrong service and returns to main page
Given I type in "Update" into the search bar
When I click on the "Update Phone" in the dropdown
And I should see the headers "Update Phone, Do it digitally, Do it at a branch"
Then I go back
